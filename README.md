maven_file1: Example Using Multiple Java EE 6 Technologies Deployed as an EAR
==============================================================================================
Author: Pete Muir
Level: Intermediate
Technologies: EAR
...
4. This will deploy `target/maven_file1.ear` to the running instance of the server.


Access the application 
---------------------

The application will be running at the following URL: <http://localhost:8080/maven_file1-web>.
...
You should see messages similar to the following:
    ...
    INFO  [group1.controller.MemberRegistration] (http--127.0.0.1-8080-2) Registering Jane Doe
    INFO  [group1.test.MemberRegistrationTest] (http--127.0.0.1-8080-2) Jane Doe was persisted with id 1
    ...
    INFO  [org.jboss.as.connector.subsystems.datasources] (MSC service thread 1-5) JBAS010409: Unbound data source [jboss/datasources/maven_file1TestDS]
